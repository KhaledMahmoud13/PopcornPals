package com.khaled.popcornpals.adapter
...
class MovieItemAdapter(val onClickListener: OnClickListener) :
    ListAdapter<Movie, MovieItemAdapter.MovieItemViewHolder>(DiffCallback) {

    class MovieItemViewHolder(private var binding: MovieItemBinding) :
